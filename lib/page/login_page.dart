...
import 'package:uber/page/anasayfa.dart';
import 'package:uber/page/kay%C4%B1t.dart';
import 'package:uber/page/sifre_unuttum.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<Map<String, dynamic>?> giriskontrol(String ad, String sifre) async {
    try {
      var okunanVeri = await rootBundle.loadString(
        "json/kisiler.json",
      ); // JSON dosyasını oku
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        //aşağı yukarı kaydırılabilir alan
        child: Padding(
          padding: const EdgeInsets.all(20.0),
          child: Column(
            mainAxisAlignment: MainAxisAlignment.start,
            children: [
              const SizedBox(height: 60), // Üstten boşluk ekledik
              // Logo resmi eklendi
              Image.asset('images/uber.jpg', width: 200, height: 200),
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  // JSON'dan kontrol et
                  Map<String, dynamic>? kullaniciVeri = await giriskontrol(
                    ad.text,
                    sifre.text,
                  );
